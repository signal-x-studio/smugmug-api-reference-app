        ...
        <div className="bg-slate-800 rounded-2xl shadow-2xl shadow-slate-950/50 border border-slate-700 p-8">
          ...
          <div className="mt-8 text-left text-sm text-slate-400 p-4 bg-slate-900/50 rounded-lg border border-slate-700 space-y-4">
            ...
            <ul className="list-disc list-inside space-y-1 pl-2">
             ...
             <p>
              The <code className="text-xs bg-slate-700 p-1 rounded">src/services/smugmugService.ts</code> file in this project contains the full client-side logic for creating a valid OAuth 1.0a signature, which you can adapt for your server-side implementation.
            </p>
          </div>
        </div>
      </div>

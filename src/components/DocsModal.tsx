    ...
    >
      ...
      >
        ...
        <div className="flex-grow overflow-y-auto p-6 md:p-8">
            ...
            <DocSubHeader>The `src/services/` Directory</DocSubHeader>
            <DocParagraph>
            ...
            <DocSubHeader>The `src/components/` Directory</DocSubHeader>
            ...
            <DocCodeBlock>
{`// In src/services/geminiService.ts -> generatePhotoMetadata()
...
const parsedData = JSON.parse(response.text.trim());`}
            ...
            <DocParagraph>
             ...
             <DocCodeBlock>
{`// In src/services/geminiService.ts -> doesImageMatchPrompt()
...
return parsedData.match === true;`}
            ...
            <DocParagraph>
             ...
             <DocCodeBlock>
{`// In src/services/geminiService.ts -> generateAlbumStory()
